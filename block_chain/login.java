          ...
          uname = jTextField1.getText();
           ...
           ResultSet rs = stmt.executeQuery(sql);
                ...
                while(rs.next())
                {
                    ...
                    unid = rs.getString("skey");
                           
                    if((uname.equals(user)) && (pwd.equals(pass)) && (uid.equals(unid)))
                        {
                           mm=0;
                            String msg = uname;
                    ...
                    */
                        ...
                        {
                            mm=0;
                            JOptionPane.showMessageDialog(this, "Invalid password or Secret Key");
                        }
                }
                if((!rs.next())&&(mm==1))
                {
