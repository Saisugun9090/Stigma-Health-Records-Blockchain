 ...
 * @author egc
 */
public class final_cloud extends javax.swing.JFrame {

    /**
     * Creates new form final_cloud
     */
    public final_cloud() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Cloud Server Process");

        jButton1.setBackground(new java.awt.Color(153, 102, 255));
        jButton1.setFont(new java.awt.Font("Cambria", 1, 14)); // NOI18N
        jButton1.setText("Check User Validity");
        ...
        jButton2.setText("Grant Permission");
        ...
        jButton3.setText("Revoke Permission");
        ...
        jLabel6.setText("Requested File");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(final_cloud.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new final_cloud().setVisible(true);
            }
        });
    }
